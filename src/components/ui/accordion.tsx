  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <PlusCircleIcon className="pointer-events-none size-6 shrink-0 translate-y-0.5 fill-[#AD28EB] text-white transition-all duration-200 group-data-[state=open]:hidden" />

        {/* Minus icon (only visible when open) */}
        <CircleMinusIcon className="pointer-events-none hidden size-6 shrink-0 translate-y-0.5 fill-[#301534] text-white transition-all duration-200 group-data-[state=open]:block" />
      </AccordionPrimitive.Trigger>
